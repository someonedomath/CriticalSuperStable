...
%	Since then, lots of analogous results were obtained for more general 
...
%	Asmussen and Hering \cite[Section~6.3~and~6.4]{AsmussenHering1983Branching} 
...
%\cite[Theorem~4.2]{AsmussenHering1983Branching} 
...
%	Suppose that $\{(Y_t)_{t\geq 0}; P\}$ is a CSBP 
...
%	There exists an $m \in \mathcal M_E^\sigma$ with full support on the state space $E$, and a family of strictly positive, 
...
%	\cite{RenSongZhang2015Limit} and \cite{RenSongZhang2017Central} 
...
%    \emph{density of semigroup $(P^\beta_t)_{t\geq 0}$}.
...
\item[(2)] 
	...
	%$0$, and is regularly varying with index $-(\gamma_0-1)^{-1}$ as $t \to \infty$.
...
%	critical superprocesses with finite second moment.
...
%	\cite{RenSongSun2017A-2-spine} and \cite{RenSongSun2017Spine}.
...
%	\cite{RenSongSun2017Spine} and \cite{RenSongZhang2015Limit} 
...
%	then according to \cite[Section 8]{Li2011Measure-valued}, 
